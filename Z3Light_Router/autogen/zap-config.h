...
#define GENERATED_ATTRIBUTES { \
  { 0x0000, ZCL_INT8U_ATTRIBUTE_TYPE, 1, (ATTRIBUTE_MASK_SINGLETON), { (uint8_t*)0x08  } }, /* 0 Cluster: Basic, Attribute: ZCL version, Side: server*/ \
	  ...
	  { 0x0006, ZCL_ENUM8_ATTRIBUTE_TYPE, 1, (ATTRIBUTE_MASK_CLIENT), { (uint8_t*)0x00  } }, /* 37 Cluster: Over the Air Bootloading, Attribute: OTA Upgrade Status, Side: client*/ \
		  ...
		  { 0x0011, ZCL_LONG_OCTET_STRING_ATTRIBUTE_TYPE, 253, (ATTRIBUTE_MASK_CLIENT), { NULL } }, /* 40 Cluster: Green Power, Attribute: proxy table, Side: client*/ \
	  ...
	  { 0x0020, ZCL_BITMAP8_ATTRIBUTE_TYPE, 1, (ATTRIBUTE_MASK_WRITABLE| ATTRIBUTE_MASK_CLIENT), { (uint8_t*)0x00  } }, /* 43 Cluster: Green Power, Attribute: gp shared security key type, Side: client*/ \
		  { 0x0021, ZCL_SECURITY_KEY_ATTRIBUTE_TYPE, 16, (ATTRIBUTE_MASK_WRITABLE| ATTRIBUTE_MASK_CLIENT), { (uint8_t*)0x00000000000000000000000000000000 } }, /* 44 Cluster: Green Power, Attribute: gp shared security key, Side: client*/ \
	  { 0x0022, ZCL_SECURITY_KEY_ATTRIBUTE_TYPE, 16, (ATTRIBUTE_MASK_WRITABLE| ATTRIBUTE_MASK_CLIENT), { (uint8_t*)&(generatedDefaults[6]) } }, /* 45 Cluster: Green Power, Attribute: gp link key, Side: client*/ \
	  { 0xFFFD, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (ATTRIBUTE_MASK_CLIENT), { (uint8_t*)0x0001  } }, /* 46 Cluster: Green Power, Attribute: cluster revision, Side: client*/ \
		  { 0x0000, ZCL_INT8U_ATTRIBUTE_TYPE, 1, (0x00), { (uint8_t*)0x00  } }, /* 47 Cluster: Color Control, Attribute: current hue, Side: server*/ \
		  { 0x0001, ZCL_INT8U_ATTRIBUTE_TYPE, 1, (0x00), { (uint8_t*)0x00  } }, /* 48 Cluster: Color Control, Attribute: current saturation, Side: server*/ \
		  { 0x0002, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (0x00), { (uint8_t*)0x0000  } }, /* 49 Cluster: Color Control, Attribute: remaining time, Side: server*/ \
		  { 0x0003, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (0x00), { (uint8_t*)0x616B  } }, /* 50 Cluster: Color Control, Attribute: current x, Side: server*/ \
		  { 0x0004, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (0x00), { (uint8_t*)0x607D  } }, /* 51 Cluster: Color Control, Attribute: current y, Side: server*/ \
		  { 0x0007, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (ATTRIBUTE_MASK_TOKENIZE), { (uint8_t*)0x00FA  } }, /* 52 Cluster: Color Control, Attribute: color temperature, Side: server*/ \
		  { 0x0008, ZCL_ENUM8_ATTRIBUTE_TYPE, 1, (0x00), { (uint8_t*)0x01  } }, /* 53 Cluster: Color Control, Attribute: color mode, Side: server*/ \
		  { 0x000F, ZCL_BITMAP8_ATTRIBUTE_TYPE, 1, (ATTRIBUTE_MASK_WRITABLE), { (uint8_t*)0x00  } }, /* 54 Cluster: Color Control, Attribute: color control options, Side: server*/ \
		  { 0x0010, ZCL_INT8U_ATTRIBUTE_TYPE, 1, (0x00), { (uint8_t*)0x00  } }, /* 55 Cluster: Color Control, Attribute: number of primaries, Side: server*/ \
		  { 0x0011, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (0x00), { (uint8_t*)0x00  } }, /* 56 Cluster: Color Control, Attribute: primary 1 x, Side: server*/ \
		  { 0x0012, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (0x00), { (uint8_t*)0x00  } }, /* 57 Cluster: Color Control, Attribute: primary 1 y, Side: server*/ \
		  { 0x0013, ZCL_INT8U_ATTRIBUTE_TYPE, 1, (0x00), { (uint8_t*)0x00  } }, /* 58 Cluster: Color Control, Attribute: primary 1 intensity, Side: server*/ \
		  { 0x0015, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (0x00), { (uint8_t*)0x00  } }, /* 59 Cluster: Color Control, Attribute: primary 2 x, Side: server*/ \
		  { 0x0016, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (0x00), { (uint8_t*)0x00  } }, /* 60 Cluster: Color Control, Attribute: primary 2 y, Side: server*/ \
		  { 0x0017, ZCL_INT8U_ATTRIBUTE_TYPE, 1, (0x00), { (uint8_t*)0x00  } }, /* 61 Cluster: Color Control, Attribute: primary 2 intensity, Side: server*/ \
		  { 0x0019, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (0x00), { (uint8_t*)0x00  } }, /* 62 Cluster: Color Control, Attribute: primary 3 x, Side: server*/ \
		  { 0x001A, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (0x00), { (uint8_t*)0x00  } }, /* 63 Cluster: Color Control, Attribute: primary 3 y, Side: server*/ \
		  { 0x001B, ZCL_INT8U_ATTRIBUTE_TYPE, 1, (0x00), { (uint8_t*)0x00  } }, /* 64 Cluster: Color Control, Attribute: primary 3 intensity, Side: server*/ \
		  { 0x0020, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (0x00), { (uint8_t*)0x00  } }, /* 65 Cluster: Color Control, Attribute: primary 4 x, Side: server*/ \
		  { 0x0021, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (0x00), { (uint8_t*)0x00  } }, /* 66 Cluster: Color Control, Attribute: primary 4 y, Side: server*/ \
		  { 0x0022, ZCL_INT8U_ATTRIBUTE_TYPE, 1, (0x00), { (uint8_t*)0x00  } }, /* 67 Cluster: Color Control, Attribute: primary 4 intensity, Side: server*/ \
		  { 0x0024, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (0x00), { (uint8_t*)0x00  } }, /* 68 Cluster: Color Control, Attribute: primary 5 x, Side: server*/ \
		  { 0x0025, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (0x00), { (uint8_t*)0x00  } }, /* 69 Cluster: Color Control, Attribute: primary 5 y, Side: server*/ \
		  { 0x0026, ZCL_INT8U_ATTRIBUTE_TYPE, 1, (0x00), { (uint8_t*)0x00  } }, /* 70 Cluster: Color Control, Attribute: primary 5 intensity, Side: server*/ \
		  { 0x0028, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (0x00), { (uint8_t*)0x00  } }, /* 71 Cluster: Color Control, Attribute: primary 6 x, Side: server*/ \
		  { 0x0029, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (0x00), { (uint8_t*)0x00  } }, /* 72 Cluster: Color Control, Attribute: primary 6 y, Side: server*/ \
		  { 0x002A, ZCL_INT8U_ATTRIBUTE_TYPE, 1, (0x00), { (uint8_t*)0x00  } }, /* 73 Cluster: Color Control, Attribute: primary 6 intensity, Side: server*/ \
		  { 0x4000, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (0x00), { (uint8_t*)0x0000  } }, /* 74 Cluster: Color Control, Attribute: enhanced current hue, Side: server*/ \
		  { 0x4001, ZCL_ENUM8_ATTRIBUTE_TYPE, 1, (0x00), { (uint8_t*)0x01  } }, /* 75 Cluster: Color Control, Attribute: enhanced color mode, Side: server*/ \
		  { 0x4002, ZCL_INT8U_ATTRIBUTE_TYPE, 1, (0x00), { (uint8_t*)0x00  } }, /* 76 Cluster: Color Control, Attribute: color loop active, Side: server*/ \
		  { 0x4003, ZCL_INT8U_ATTRIBUTE_TYPE, 1, (0x00), { (uint8_t*)0x00  } }, /* 77 Cluster: Color Control, Attribute: color loop direction, Side: server*/ \
		  { 0x4004, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (0x00), { (uint8_t*)0x0019  } }, /* 78 Cluster: Color Control, Attribute: color loop time, Side: server*/ \
		  { 0x4005, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (0x00), { (uint8_t*)0x2300  } }, /* 79 Cluster: Color Control, Attribute: color loop start enhanced hue, Side: server*/ \
		  { 0x4006, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (0x00), { (uint8_t*)0x0000  } }, /* 80 Cluster: Color Control, Attribute: color loop stored enhanced hue, Side: server*/ \
		  { 0x400A, ZCL_BITMAP16_ATTRIBUTE_TYPE, 2, (0x00), { (uint8_t*)0x0000  } }, /* 81 Cluster: Color Control, Attribute: color capabilities, Side: server*/ \
		  { 0x400B, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (0x00), { (uint8_t*)0x0000  } }, /* 82 Cluster: Color Control, Attribute: color temp physical min, Side: server*/ \
		  { 0x400C, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (0x00), { (uint8_t*)0xFEFF  } }, /* 83 Cluster: Color Control, Attribute: color temp physical max, Side: server*/ \
		  { 0x400D, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (0x00), { (uint8_t*)0x00  } }, /* 84 Cluster: Color Control, Attribute: couple color temp to level min-mireds, Side: server*/ \
		  { 0x4010, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (ATTRIBUTE_MASK_WRITABLE| ATTRIBUTE_MASK_TOKENIZE), { (uint8_t*)0x4444  } }, /* 85 Cluster: Color Control, Attribute: start up color temperature mireds, Side: server*/ \
		  { 0xFFFD, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (0x00), { (uint8_t*)0x0001  } }, /* 86 Cluster: Color Control, Attribute: cluster revision, Side: server*/ \
		  { 0xFFFD, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (ATTRIBUTE_MASK_CLIENT), { (uint8_t*)0x0001  } }, /* 87 Cluster: Occupancy Sensing, Attribute: cluster revision, Side: client*/ \
		  { 0xFFFD, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (0x00), { (uint8_t*)0x0001  } } /* 88 Cluster: ZLL Commissioning, Attribute: cluster revision, Side: server*/ \
		 }
...
#define GENERATED_CLUSTERS { \
  { 0x0000, (EmberAfAttributeMetadata*)&(generatedAttributes[0]), 14, 0, CLUSTER_MASK_SERVER, NULL }, /* 0, Endpoint Id: 1, Cluster: Basic, Side: server*/ \
	  ...
	  { 0x0406, (EmberAfAttributeMetadata*)&(generatedAttributes[87]), 1, 2, CLUSTER_MASK_CLIENT, NULL }, /* 7, Endpoint Id: 1, Cluster: Occupancy Sensing, Side: client*/ \
	  { 0x1000, (EmberAfAttributeMetadata*)&(generatedAttributes[88]), 1, 2, CLUSTER_MASK_SERVER, NULL }, /* 8, Endpoint Id: 1, Cluster: ZLL Commissioning, Side: server*/ \
	  ...
	  { 0x0300, (EmberAfAttributeMetadata*)&(generatedAttributes[47]), 40, 66, CLUSTER_MASK_SERVER, NULL }, /* 16, Endpoint Id: 2, Cluster: Color Control, Side: server*/ \
	  { 0x1000, (EmberAfAttributeMetadata*)&(generatedAttributes[88]), 1, 2, CLUSTER_MASK_SERVER, NULL }, /* 17, Endpoint Id: 2, Cluster: ZLL Commissioning, Side: server*/ \
	  { 0x0021, (EmberAfAttributeMetadata*)&(generatedAttributes[39]), 8, 295, CLUSTER_MASK_CLIENT, NULL } /* 18, Endpoint Id: 242, Cluster: Green Power, Side: client*/ \
	 }
...
#define GENERATED_ENDPOINT_TYPES { \
  { ((EmberAfCluster*)&(generatedClusters[0])), 9, 50 }, \
	  ...
	  { ((EmberAfCluster*)&(generatedClusters[18])), 1, 295 }, \
	 } 
